/*************************************************************************************************
                                      PROGRAMMINFO
**************************************************************************************************
Funktion: WLAN MAX7219 Laufschrift  
...
Inbetriebnahme:
1. Programm in ESP32 laden
2. Esp32 Data upload
3. Kontrolle im Seriellen Monitor 115200
4. Mit MM-Text verbinden (Passwort 12345678)
192.168.4.1/main aufrufen und Text aktualisieren
ESP32 neu programmiert am 10.10.2023
                                                                                     */
/* Libraries:                                                                           */
/*            MD_MAX72XX-master                                                         */
...
#define MAX_SEGMENTS 12                            /* Number of used Led matrixes */
...
void setup()
{
  ...
  {
    WEB_PAGE_STRING = "Verbinde WLAN "; 
    WEB_PAGE_STRING += AP_WLAN_SSID;
    WEB_PAGE_STRING += ", oeffne Webseite "; 
    ...
    WEB_PAGE_STRING += "/main mit einem Browser!";
  }
  /* Convert to char string */
